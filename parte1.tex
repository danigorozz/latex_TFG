...
\begin{figure}[h]
	\begin{center} 
	\includegraphics[width=0.6\textwidth]{plano_metro.png}
	\end{center}
...
\begin{figure}[H]
	...
	\end{center}
	\caption{Comparación del resultado teórico de una medición de un láser 2D y un sensor RGBD sobre elementos presentes en la Escuela de Ingenierías Industriales.}
...
En una cuarta y última parte se sitúan los apéndices del proyecto. En el primero y único se explica el software que se ha utilizado de apoyo pero que no se ha mencionado en los capítulos anteriores.\\
