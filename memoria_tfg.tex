...
\begin{figure}[h]
 ...
 \caption{Resultados para distintos valores de distancias máxima}
 \label{fig:scans_range}
\end{figure}


\section{Análisis de la fiabilidad de YOLO}
...
Con el nodo \texttt{write\_objects} obteníamos un archivo de 
